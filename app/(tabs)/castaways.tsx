  ...
  return (
    ...
    <SectionList
      ...
      renderSectionHeader={({ section }) => {
        ...
        return (
        <Glass
          style={[styles.tribeHeader, { borderLeftColor: tribeColors[section.tribe] }, isFirst && { marginTop: 0 }]}
...
const styles = StyleSheet.create({
  ...
  screenTitle: { color: colors.textPrimary, fontSize: 34, fontWeight: '800', paddingHorizontal: 16, paddingTop: 8, paddingBottom: 8 },
  listContainer: { flex: 1 },
  centered: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: colors.background },
  list: { paddingBottom: 32 },
  tribeHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 10, borderLeftWidth: 3, marginTop: 16, overflow: 'hidden' },
