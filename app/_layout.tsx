...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      retry: 1,
      staleTime: 1000 * 30,
      gcTime: 1000 * 60 * 60 * 24, // 24 h — keep cache long enough to persist
    },
  },
});
...
function AuthGate() {
  ...
  return (
    <Stack screenOptions={{ headerShown: false, contentStyle: { backgroundColor: colors.background } }}>
      ...
      <Stack.Screen name="players/gallery" options={{ presentation: 'card', headerShown: true, title: 'Player Bios', headerBackTitle: 'Back', headerStyle: { backgroundColor: colors.background }, headerTintColor: colors.textPrimary, headerShadowVisible: false }} />
      <Stack.Screen name="profile/bio" options={{ presentation: 'card', headerShown: true, title: 'Survivor Bio', headerBackTitle: 'Back', headerStyle: { backgroundColor: colors.background }, headerTintColor: colors.textPrimary, headerShadowVisible: false }} />
